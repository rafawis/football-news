...
from main.views import register,login_user, logout_user, show_main, create_news, edit_news,delete_news,show_news, show_xml, show_json, show_xml_by_id, show_json_by_id, add_news_entry_ajax
